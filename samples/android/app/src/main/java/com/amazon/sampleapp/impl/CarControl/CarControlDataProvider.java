...
public class CarControlDataProvider {
    ...
    public static EngineConfiguration generateCarControlConfig() {
        ...
        //---------------------------------------------------------------------
        String[] controlIds = { "driver.fan", "passenger.fan", "rear.fan", "front.fan", "all.fan" };
        String[] zones = {  CarControlConfiguration.Zone.DRIVER,
                            CarControlConfiguration.Zone.PASSENGER,
                            CarControlConfiguration.Zone.REAR,
                            CarControlConfiguration.Zone.FRONT,
                            CarControlConfiguration.Zone.ALL };
        ...
        //---------------------------------------------------------------------
        controlIds = new String[] { "driver.heater", "passenger.heater", "all.heater", "secondRow.heater", "thirdRow.heater" };
        zones = new String[] { CarControlConfiguration.Zone.DRIVER,
                  CarControlConfiguration.Zone.PASSENGER,
                  CarControlConfiguration.Zone.ALL,
                  CarControlConfiguration.Zone.SECOND_ROW,
                  CarControlConfiguration.Zone.THIRD_ROW };
        for (int i=0; i < controlIds.length; i++) {
            config.createControl(controlIds[i], zones[i])
        ...
        //---------------------------------------------------------------------
        controlIds = new String[] { "driver.light", "passenger.light", "front.light", "secondRow.light" };
        zones = new String[] { CarControlConfiguration.Zone.DRIVER,
                  CarControlConfiguration.Zone.PASSENGER,
                  CarControlConfiguration.Zone.FRONT,
                  CarControlConfiguration.Zone.SECOND_ROW };
